...
<p class="mt-1.5 text-sm text-navy-500">Tidak perlu kartu kredit, langsung bisa dipakai.</p>
...
{#if sent}
	<div class="mt-6 flex items-start gap-3 rounded-xl border border-vendor-200 bg-vendor-50 p-4 text-sm text-vendor-700">
		...
		<p>Link masuk sudah dikirim ke <strong>{email}</strong>. Klik link itu untuk menyelesaikan pendaftaran.</p>
	</div>
{:else}
